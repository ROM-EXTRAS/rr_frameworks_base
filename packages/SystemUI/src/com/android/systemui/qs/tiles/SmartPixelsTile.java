...
public class SmartPixelsTile extends QSTile<QSTile.BooleanState> {
    ...
    private SmartPixelsTileObserver mObserver;

    public SmartPixelsTile(Host host) {
        super(host);
        mObserver = new SmartPixelsTileObserver(mHandler);
    ...
    protected void handleSecondaryClick() {
        mHost.startActivityDismissingKeyguard(SMART_PIXELS_SETTINGS);
    }
...
//        state.state = state.value ? Tile.STATE_ACTIVE : Tile.STATE_INACTIVE;
    ...
    private class SmartPixelsTileObserver extends ContentObserver {
        public SmartPixelsTileObserver(Handler handler) {
            super(handler);
        }
    }
}
